...
```{r data transformation for alluvium}
# pivot longer
...
```{r data transformation for mosaic, echo=FALSE}
data2 <- data2 %>% mutate(
...
```{r mosaic plot facet on disease}
ggplot(data=data2) +
...
##Bar-chart facet by smoking Eeposure
